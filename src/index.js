...
function generateRecipe(event) {
  ...
  recipeElement.innerHTML = `<div class="blink_me">Wait! I'm genereting a delicious vegan recipe with ${ingredientsInput.value} for you 🌱</div>`;
